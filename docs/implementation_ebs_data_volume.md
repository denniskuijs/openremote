...
After setting the `availabilty zone` name to the `SUBNET_AZ` variable I can begin creating the `EBS` data volume. 
...
<img src="./Media/review_10.png" width="1000">
